Rails.application.routes.draw do
  ...
  #  resources :boards
    ...
    get  '/boards/:id/stories/:story_id/accept', to: 'stories#accept',   as: 'acceptstory'
    get  '/boards/:id/stories/:story_id/reject', to: 'stories#reject',   as: 'rejectstory'
    post '/boards/:id/stories/:story_id/reject', to: 'stories#do_reject'
