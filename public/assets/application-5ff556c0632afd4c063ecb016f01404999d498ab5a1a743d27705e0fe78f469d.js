...
console.log('we did it');{{{{FUCK THIS
$(document).on('turbolinks:load', function() {
    sprintsLoc = window.location.pathname.indexOf('sprints');
    sprintSlashLoc = window.location.pathname..indexOf('/', sprintsLoc + 8);
    sprintID = window.location.pathname(sprintsLoc + 8, sprintSlashLoc);

    boardsLoc = window.location.pathname.indexOf('boards');
    boardSlashLoc = window.location.pathname..indexOf('/', sprintsLoc + 7);
    boardID = window.location.pathname(sprintsLoc + 7, slashLoc);
    console.log('boop');

    $('#sprint_sprint_id').change(function() {
        console.log('hey');
        selection = $(this).find('option:selected').val();
        window.open('/boards/' + boardID + '/sprints/' + selection);
    });
})
;
(function() {
